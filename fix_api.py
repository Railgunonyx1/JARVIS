#!/usr/bin/env python
with open('memory/api.py', 'r', encoding='utf-8', errors='surrogateescape') as f:
    content = f.read()

# The exact old string (with em-dash � characters)
...
if old_start in content:
    ...
    print('Old string not found - showing first 100 chars around the area:')
    idx = content.find('def format_for_prompt')
    if idx >= 0:
