"""NVIDIA NIM Provider — hosted Llama/Nemotron models via build.nvidia.com.

OpenAI-compatible endpoint at https://integrate.api.nvidia.com/v1. Free tier
grants ~1000 credits with 40 RPM / 1000 RPD rate limits.
"""
...
class NVIDIAProvider(LLMProvider):
    ...
    def __init__(self, config: dict, api_key: str):
        super().__init__("nvidia_nim", config)
    ...
    async def complete(
        ...
        try:
            ...
            response = await client.chat.completions.create(
                model=self.config.get("model", "nvidia/llama-3.3-70b-instruct"),
            ...
            error_str = str(e)
            if "rate" in error_str.lower() or "429" in error_str.lower() or "quota" in error_str.lower():
